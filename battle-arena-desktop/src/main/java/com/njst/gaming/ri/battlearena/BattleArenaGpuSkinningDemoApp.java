...
public final class BattleArenaGpuSkinningDemoApp extends Engine {
    ...
    protected void configureInputBindings(InputBindings bindings) {
        ...
        bindings.bindKey(GLFW_KEY_SLASH, BattleArenaActions.CREATE_WATER);
        bindings.bindKey(GLFW_KEY_F, BattleArenaActions.CREATE_ICE);
        bindings.bindKey(GLFW_KEY_C, BattleArenaActions.CREATE_EARTH);
        bindings.bindKey(GLFW_KEY_G, BattleArenaActions.SHAPE_SPEAR);
        bindings.bindKey(GLFW_KEY_H, BattleArenaActions.SHAPE_WALL);
        bindings.bindKey(GLFW_KEY_J, BattleArenaActions.COOL);
        bindings.bindKey(GLFW_KEY_K, BattleArenaActions.HEAT);
        bindings.bindKey(GLFW_KEY_Q, BattleArenaActions.KICK);
        bindings.bindKey(GLFW_KEY_X, BattleArenaActions.MOVE_FORWARD);
