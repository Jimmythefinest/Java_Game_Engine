...
public class SML {
    ...
    public static void main(String[] args) {
        try {
            ...
            NeuralNetwork sml = new NeuralNetwork(
                    new int[] { unique_word_list.length * 2, 20, unique_word_list.length }, 0.1, false);
            ...
            while (traing_active) {
                ...
                for (i = 1; i < one_hot_encoded_word_list.length - 1 && i < 100; i++) {
                    if (unique_word_list[Embedder.indexOfMax(one_hot_encoded_word_list[i + 1])].equals("the")) {
                        ...
                        System.arraycopy(one_hot_encoded_word_list[i], 0, input, unique_word_list.length,
                                unique_word_list.length);
            ...
            for (i = 0; i < 10; i++) {
                ...
                last_word = wordtovector(unique_word_list.length,
                        get_index(unique_word_list[indices[0]], unique_word_list));
